...
from second.pytorch.models import middle, rpn, voxel_encoder, pointpillars2_msg, pointpillars2_ssg ,pointpillars
...
class VoxelNet(nn.Module):
    ...
    def network_forward(self, voxels, num_points, coors, batch_size):
        ...
        # print("before voxel feature extractor")
        voxel_features = self.voxel_feature_extractor(voxels, num_points,
                                                      coors)
        # print("after voxel feature extractor")
        self.end_timer("voxel_feature_extractor")

        self.start_timer("middle forward")
        # print("before middle feature extractor")
        spatial_features = self.middle_feature_extractor(
            voxel_features, coors, batch_size)
        # print("after middle feature extractor")
